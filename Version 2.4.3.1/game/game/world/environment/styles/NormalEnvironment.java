...
import game.objects.classes.environment.AppleTree;
import game.objects.classes.environment.Fern;
...
public class NormalEnvironment implements Environment {
	...
	protected LoaderTexIdentity[] textures = null;
	protected LoaderTexIdentity[] normalTextures = null;
	...
	@Override
	public void init() {
		textures = Environment.loadTextures(this);
	}
	...
	public GameObject dealWithMediumGenerationPoint(Vector3f pos, Random random, WorldVariables worldVars) {
		...
		GameObject tree = new AppleTree(worldVars, pos, new Vector3f(0,rot,0), height);
		return tree;
//		return null;
	}
	...
	public GameObject dealWithSmallGenerationPoint(Vector3f pos, Random random, WorldVariables worldVars) {
		...
		return new Fern(pos, new Vector3f(), 0.1f, (int)index, worldVars);
//		return null;
	}

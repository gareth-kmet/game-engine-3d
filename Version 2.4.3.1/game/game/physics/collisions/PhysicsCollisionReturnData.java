...
public record PhysicsCollisionReturnData(byte collisionType,boolean terrainCollision,HashSet<Collidable> collisions) {
	...
	static final PhysicsCollisionReturnData NON_EXISTANT_COLLISION = new PhysicsCollisionReturnData(EXIST_NULL_COLLISION, false, new HashSet<Collidable>());
}

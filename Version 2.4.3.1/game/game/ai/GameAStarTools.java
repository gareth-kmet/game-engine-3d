...
public class GameAStarTools {
	...
	public static class NodeEntity extends RenderEntity{public NodeEntity() {super(null, 0, null, 0, 0, 0, 1);}}

	public static final RenderEntity NODE_ENTITY = new GameAStarTools.NodeEntity();
...
//			}
	...
	public static class AStarFollower extends Intelligence{
		...
		public void decide(WorldVariables worldVariables) {
			...
			final float deltaTime = worldVariables.currentFrameDeltaTime;

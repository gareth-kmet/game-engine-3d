...
public class ParticleRenderer {
	...
	protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix){
		this.loader=loader;
		this.vbo = loader.createEmptyVbo(INSTANCE_DATA_LENGTH*MAX_INSTANCES).id;
		quad = loader.loadToVAO(VERTICES, 2);
		loader.addInstanceAttribute(quad.getVaoID(loader), vbo, 1, 4, INSTANCE_DATA_LENGTH, 0);
		loader.addInstanceAttribute(quad.getVaoID(loader), vbo, 2, 4, INSTANCE_DATA_LENGTH, 4);
		loader.addInstanceAttribute(quad.getVaoID(loader), vbo, 3, 4, INSTANCE_DATA_LENGTH, 8);
		loader.addInstanceAttribute(quad.getVaoID(loader), vbo, 4, 4, INSTANCE_DATA_LENGTH, 12);
		loader.addInstanceAttribute(quad.getVaoID(loader), vbo, 5, 4, INSTANCE_DATA_LENGTH, 16);
		loader.addInstanceAttribute(quad.getVaoID(loader), vbo, 6, 1, INSTANCE_DATA_LENGTH, 20);
	...
	protected void render(Map<ParticleTexture, List<Particle>> particles, Camera camera){
		...
		for(ParticleTexture texture : particles.keySet()) {
			...
			for(Particle particle : particleList) {
				...
				updateTexCoordInfor(particle, vboData);
			}
	...
	private void updateTexCoordInfor(Particle particle, float[] data) {

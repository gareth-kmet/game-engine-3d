...
public class Fbo {
	...
	private void initialiseFrameBuffer(int type) {
		...
		if(multisampleAndMultiTarget) {
			colourBuffer = createMultisampleColourAttachement(GL30.GL_COLOR_ATTACHMENT0);
			colourBuffer2 = createMultisampleColourAttachement(GL30.GL_COLOR_ATTACHMENT1);
		}else {
	...
	private int  createMultisampleColourAttachement(int attachment) {

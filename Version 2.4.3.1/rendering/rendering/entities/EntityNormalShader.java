...
final class EntityNormalShader extends EntityRenderer.EntityShader{
	
	private static final int MAX_LIGHTS = 4;
	
	private static final String VERTEX_FILE = "rendering/rendering/entities/VNShader.glsl";
	...
	protected void loadUseMaterial(boolean use) {
		super.loadBoolean(location_useMaterial, false);

...
class TerrainShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = "rendering/rendering/terrain/terrainVertexShader.glsl", 
			FRAGMENT_FILE = "rendering/rendering/terrain/terrainFragmentShader.glsl";
	...
	protected void getAllUniformLocations() {
		...
		location_textures = new int[Environment.MAX_GL_TEXTURES];
	...
	public void connectTextureUnits() {
		...
		for (int i = 0; i < location_textures.length; i++) {
			super.loadInt(location_textures[i], Environment.MIN_GL_TEXTURE_NUM+i);
		}
	}

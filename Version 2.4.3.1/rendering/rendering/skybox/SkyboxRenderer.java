...
public class SkyboxRenderer {
	...
	public void render(Camera camera) {
		...
		shader.loadFogColour(SkyBoxVariables.Fog.colour.x,SkyBoxVariables.Fog.colour.y, SkyBoxVariables.Fog.colour.z);
		GL30.glBindVertexArray(cube.getVaoID(loader));

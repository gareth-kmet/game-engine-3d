...
public abstract class EntityRenderCondition {
	...
	public static abstract class SophisticatedEntityRenderCondition extends EntityRenderCondition{
		...
		private record PreFill(int frameId, boolean condition) {}
		private record ResFill(int frameId, float result) {}
		private record NorFill(int frameId, boolean condition) {}
